...
enum NotchVisibility: String, CaseIterable, Identifiable {
    ...
    var explanation: String {
        ...
        case .hidden:
            ...
            return L10n.t("Nothing on screen. The readings stay in the menu bar menu when App icon is Menu bar. Otherwise, open PenguinNotch again from Applications to bring these settings back.")
        }
    }
}
