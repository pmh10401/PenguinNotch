...
/// Where PenguinNotch shows itself, apart from the notch.
///
...
enum AppPresence: String, CaseIterable, Identifiable {
    ...
    var explanation: String {
        switch self {
        case .dock:
            return L10n.t("A normal app icon in the Dock while PenguinNotch is running.")
        case .menuBar:
        ...
        case .hidden:
            ...
            return L10n.t("No icon anywhere. Open PenguinNotch again from Applications to bring these settings back.")
        }
    }
