...
pub fn tr(lang: &str, key: &str) -> &'static str {
    ...
    match (l, key) {
        ...
        ("pt-BR", "quit_app") => "Encerrar o PenguinNotch",
        ...
        ("zh", "quit_app") => "退出 PenguinNotch",
        ("zh-Hant", "quit_app") => "結束 PenguinNotch",
        ("ja", "quit_app") => "PenguinNotch を終了",
        ("ko", "quit_app") => "PenguinNotch 종료",
        ("ru", "quit_app") => "Выйти из PenguinNotch",
        ("uk", "quit_app") => "Вийти з PenguinNotch",
        (_, "quit_app") => "Quit PenguinNotch",
        ("zh", "settings") => "设置…",
        ("zh-Hant", "settings") => "設定…",
        ("ja", "settings") => "設定…",
        ("ko", "settings") => "설정…",
...
mod tests {
    ...
    const RUSSIAN_KEYS: &[(&str, &str)] = &[
        ...
        ("quit_app", "Выйти из PenguinNotch"),
    ...
    const BRAZILIAN_PORTUGUESE_KEYS: &[(&str, &str)] = &[
        ...
        ("quit_app", "Encerrar o PenguinNotch"),
