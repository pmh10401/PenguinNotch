...
| codex.svg | icons/openai.svg | Codex cell (the OpenAI mark, matching upstream PenguinNotch's glyph choice) |
...
**Overrides**: a file of the same name (`.svg` or `.png`) in `%APPDATA%\penguinnotch\glyphs\` takes
