...
final class ClaudeUsageCLITests: XCTestCase {
    ...
    func testTheScratchDirectoryIsOneFixedPlace() throws {
        ...
        XCTAssertEqual(first.path, support.appendingPathComponent("PenguinNotch/usage-scratch").path)
    ...
    func testAScratchDirectoryThatCannotBeMadeThrows() throws {
        ...
        FileManager.default.createFile(atPath: support.appendingPathComponent("PenguinNotch").path,
                                       contents: Data())
